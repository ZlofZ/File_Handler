package tobo.transmar.IO.helper;
...
public class FileSearcher{
	 ...
	 * @return true if successful save.
	 */
	public boolean saveFile(String text, String fileName, String path){
	 ...
	 * @return true if successful save.
	 */
	public boolean saveFile(String text, File file){
	 ...
	 * @return true if successful save.
	 */
	public boolean saveFile(String[] lines, String fileName){
	 ...
	 * @return true if successful save.
	 */
	public boolean saveFile(String[] lines, String fileName, String path){
	 ...
	 * @return true if successful save.
	 */
	public boolean saveFile(String[] lines, File file){
		try{
